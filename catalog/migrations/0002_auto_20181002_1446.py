# Generated by Django 2.1.2 on 2018-10-02 18:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Enter unique ID for this particular book', primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre got this book', to='catalog.Genre'),
        ),
    ]
